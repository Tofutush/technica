...
/*
    ...
    and use the provided MinigameManagerTrue.cs class
*/

[RequireComponent(typeof(Rigidbody2D))]
[RequireComponent(typeof(PlayerInput))] // This component must be attached to the GameObject for input to register
public class PlayerControllerMain : MonoBehaviour, MinigameSubscriber
{
    ...
    /*void OnInteract(InputValue val)
    {
        ...
        MinigameManagerTrue.SetStateToSuccess(); // Change the minigame state to "Success"
        MinigameManagerTrue.EndGame(); // End the minigame. Without this, the minigame would end when the timer finishes instead (still with success).
    } */
